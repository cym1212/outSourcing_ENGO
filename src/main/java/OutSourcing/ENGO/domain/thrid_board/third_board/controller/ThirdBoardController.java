...
public class ThirdBoardController {
    ...
    @GetMapping("/search")
    public Page<ThirdBoardListResponseDTO> searchThirdBoard(
        ...
        return thirdBoardService.searchBoards(query, searchBy, pageable);
    }
    ...
    public Page<ThirdBoardListResponseDTO> getAllThirdBoards(
        ...
        Pageable pageable = PageRequest.of(page, size, Sort.by(Sort.Direction.DESC, "createdAt"));
        return thirdBoardService.getAllThirdBoards(pageable);
    }
